...
<head>
    ...
    <title>MinhHieu | HOME</title>
     <link rel="stylesheet" href="_thanhdieu.css" />
     <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" />
     <link rel="stylesheet" href="index.css" />
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons+Round" rel="stylesheet">
    <meta name="author" content="Đây Là Website Của MinhHieu-Dev, Rất Mong Được Chào Đón Bạn !">
    <meta property="og:title" content="HELLO TA CHI HẢO - THIS IS MinhHieuTV !">
    <meta property="og:type" content="website">
    <meta property="og:url" content="http://minhhieu.com/">
    <meta property="og:image" content="http://thanhdieu.com/files/thanhdieugirl.jpg">
    <meta property="og:image:width" content="120">
    <meta property="og:image:height" content="120">
    <meta property="og:site_name" content="MinhHieuTV">
...
<body class="Border" onLoad="onCreate()">
   ...
   <!-- ===== ❀ NƠI EDIT AVATAR ❀ ===== -->
    <p align="center">
    <img  class="Blob" src="https://img.win3000.com/m00/48/02/085e1a8c2dec126cfd3ec0b17994bbec.jpg" width="96" height="96" alpha="@MinhHieu@"></p>
    <h2 class="NameFtMinhHieu" align="center">
    TRUONG MINH HIEU <i class="fa fa-check-circle"></i></h2> 
    <h2 class="TieuSu">
    Hey brother, I'm a Developer.<br>I like website design :)</h2>
    <br><hr class="New"><br>
    <!-- Thông Tin Liên Hệ -->
    <h2 class="NameFtMinhHieu">
    Contact Social
    </h2>
    <ul class="icons">
    <br>
    <div class="ManẫngHoiFtMinhHieu">
  ...
  <h2>Mobile Banks</h2>
    ...
    <p class="ThongTinThanhToanText">STK: 47331234567899 || CTK Truong Minh Hieu</p>
    </div>
    <br>
    <div class="ThongTinThanhToan">
    <p class="ThongTinThanhToanTitle">Momo Bank</p>
    <p class="ThongTinThanhToanText">STK 0967711409 || CTK Truong Minh Hieu</p>
    </div>
    <br>
    <div class="ThongTinThanhToan">
    <p class="ThongTinThanhToanTitle">Paypal</p>
    <p class="ThongTinThanhToanText" >Chx Cập Nhật !</p>
    </div>
    <br>
    <br>
    ...
    <footer class="Cuoi Trang">
      <p class="MinhHieuFtCopyright">
        <!-- ===== Thông điệp cuối cùng cho người xem ===== -->
<p class="rainbow" class="copyright">Created by <a style="text-decoration: none;" class="copyright" href="https://www.facebook.com/mhiiuu?mibextid=LQQJ4d"><font class="rainbow" color="white"> MinhHieuTV</font></a>
<br> <strong>All rights reserved - © 2022 </strong></p>
    </footer>
    </div>
    <div id="Toast">Welcome to the website MinhHieu :)</div>
